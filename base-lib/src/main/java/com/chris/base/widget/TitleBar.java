...
//        mLeftText.setPadding(mOutPadding, 0, mOutPadding, 0);
        mLeftImage.setImageResource(R.drawable.ic_titlebar_back_black);
...
//        addView(mLeftText, layoutParams);
        LayoutParams leftImageParams = new LayoutParams(getResources().getDimensionPixelSize(R.dimen.dp_48), LayoutParams.MATCH_PARENT);
...
//        addView(titleView);
    ...
    public View addAction(Action action, int index) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            params = new LinearLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.dp_48), LayoutParams.MATCH_PARENT);
        } else {
    ...
    private View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ...
            text.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.sp_13_5));
