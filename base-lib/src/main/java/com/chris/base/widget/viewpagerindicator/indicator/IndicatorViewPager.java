...
import com.chris.base.widget.viewpagerindicator.indicator.Indicator.IndicatorAdapter;
import com.chris.base.widget.viewpagerindicator.indicator.Indicator.OnTransitionListener;
import com.chris.base.widget.viewpagerindicator.indicator.slidebar.ScrollBar;
import com.chris.base.widget.viewpagerindicator.viewpager.RecyclingPagerAdapter;
		...
		indicatorView.setOnItemSelectListener(new Indicator.OnItemSelectedListener() {
			...
			public void onItemSelected(View selectItemView, int select, int preSelect) {
				if (viewPager instanceof ScrollViewPager) {
					viewPager.setCurrentItem(select, ((ScrollViewPager) viewPager).isCanScroll());
				} else {
