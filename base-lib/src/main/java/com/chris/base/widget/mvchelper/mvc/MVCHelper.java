...
import com.chris.base.widget.mvchelper.mvc.ILoadViewFactory.ILoadMoreView;
import com.chris.base.widget.mvchelper.mvc.ILoadViewFactory.ILoadView;
import com.chris.base.widget.mvchelper.mvc.IRefreshView.OnRefreshListener;
import com.chris.base.widget.mvchelper.mvc.imp.DefaultLoadViewFactory;
import com.chris.base.widget.mvchelper.mvc.viewhandler.ListViewHandler;
import com.chris.base.widget.mvchelper.mvc.viewhandler.RecyclerViewHandler;
import com.chris.base.widget.mvchelper.mvc.viewhandler.ViewHandler;
import com.chris.base.widget.mvchelper.task.Code;
import com.chris.base.widget.mvchelper.task.IAsyncTask;
import com.chris.base.widget.mvchelper.task.ISuperTask;
import com.chris.base.widget.mvchelper.task.ITask;
import com.chris.base.widget.mvchelper.task.TaskHelper;
import com.chris.base.widget.mvchelper.task.imp.SimpleCallback;
import com.chris.base.widget.mvchelper.utils.NetworkUtils;
...
//                        refreshView.showRefreshing();
    ...
    private OnScrollBottomListener onScrollBottomListener = new OnScrollBottomListener() {
        ...
        public void onScorllBootom() {
            boolean hasMore = dataSource instanceof IAsyncDataSource ?
                    ((IAsyncDataSource) dataSource).hasMore() : hasMoreData;
            if (autoLoadMore && hasMore && !isLoading()) {
                // 如果网络可以用
