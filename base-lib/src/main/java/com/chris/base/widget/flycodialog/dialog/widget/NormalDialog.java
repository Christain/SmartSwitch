...
import com.chris.base.widget.flycodialog.dialog.widget.internal.BaseAlertDialog;
...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public void setUiBeforShow() {
        ...
        if (mStyle == STYLE_ONE) {
            ...
            mTvContent.setPadding(dp2px(15), dp2px(9), dp2px(15), dp2px(12));
            mTvContent.setMinHeight(dp2px(56));
            if (mContentGravity != Gravity.CENTER_VERTICAL) {
                mTvContent.setGravity(mContentGravity);
            } else {
