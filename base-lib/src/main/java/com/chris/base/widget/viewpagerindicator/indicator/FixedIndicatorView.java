package com.chris.base.widget.viewpagerindicator.indicator;
...
import com.chris.base.widget.viewpagerindicator.indicator.slidebar.ScrollBar;
import com.chris.base.widget.viewpagerindicator.indicator.slidebar.ScrollBar.Gravity;
...
public class FixedIndicatorView extends LinearLayout implements Indicator {
    ...
    private OnFrontItemClicklistener onFrontItemClicklistener;
    ...
    private OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (itemClickable) {
                ...
                setCurrentItem(i);
                if (onFrontItemClicklistener == null || (onFrontItemClicklistener != null && onFrontItemClicklistener.itemClicklistener(parent.getChildAt(0), i, mPreSelectedTabIndex))) {
    ...
    public void setOnFrontItemClicklistener(OnFrontItemClicklistener onFrontItemClicklistener) {
        this.onFrontItemClicklistener = onFrontItemClicklistener;
    }
    ...
    public interface OnFrontItemClicklistener {
         ...
         * @param select
         * @param preSelect
         * @return 返回true调用切换，反之不切换
         */
        boolean itemClicklistener(View selectItemView, int select, int preSelect);
    }
