 ...
 */
package com.chris.base.widget.viewpagerindicator.indicator.slidebar;
...
import com.chris.base.widget.viewpagerindicator.indicator.Indicator;
...
public class TextWidthColorBar extends ColorBar {
	...
	private int realWidth = 0;//真实的宽度
	private int wantWidth = 0;//想要的宽度

	public TextWidthColorBar(Context context, Indicator indicator, int color, int height) {
		this(context, indicator, color, height, 0, Gravity.BOTTOM);
	}

	public TextWidthColorBar(Context context, Indicator indicator, int color, int height, int width) {
		this(context, indicator, color, height, width, Gravity.BOTTOM);
	}

	public TextWidthColorBar(Context context, Indicator indicator, int color, int height, Gravity gravity) {
		this(context, indicator, color, height, 0, gravity);
	}

	public TextWidthColorBar(Context context, Indicator indicator, int color, int height, int width, Gravity gravity) {
