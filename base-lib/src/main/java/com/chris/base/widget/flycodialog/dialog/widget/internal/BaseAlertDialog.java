package com.chris.base.widget.flycodialog.dialog.widget.internal;
...
import com.chris.base.widget.flycodialog.dialog.listener.OnBtnClickL;
import com.chris.base.widget.flycodialog.dialog.widget.base.BaseDialog;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
    ...
    /** 字体单位 */
    protected int textUnit = TypedValue.COMPLEX_UNIT_SP;
    ...
    public void setUiBeforShow() {
        ...
        mTvTitle.setTextSize(textUnit, mTitleTextSize);

        /** content */
        mTvContent.setGravity(mContentGravity);
        mTvContent.setText(mContent);
        mTvContent.setTextColor(mContentTextColor);
        mTvContent.setTextSize(textUnit, mContentTextSize);
        ...
        mTvBtnLeft.setTextSize(textUnit, mLeftBtnTextSize);
        mTvBtnRight.setTextSize(textUnit, mRightBtnTextSize);
        mTvBtnMiddle.setTextSize(textUnit, mMiddleBtnTextSize);
