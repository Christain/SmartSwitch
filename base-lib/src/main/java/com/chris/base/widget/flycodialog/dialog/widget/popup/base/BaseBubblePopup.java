package com.chris.base.widget.flycodialog.dialog.widget.popup.base;
...
import com.chris.base.widget.flycodialog.animation.BounceEnter.BounceLeftEnter;
import com.chris.base.widget.flycodialog.animation.FadeExit.FadeExit;
import com.chris.base.widget.flycodialog.dialog.utils.CornerUtils;
import com.chris.base.widget.flycodialog.dialog.utils.StatusBarUtils;
import com.chris.base.widget.flycodialog.dialog.view.TriangleView;
import com.chris.base.widget.flycodialog.dialog.widget.internal.InternalBasePopup;
...
public abstract class BaseBubblePopup<T extends BaseBubblePopup<T>> extends InternalBasePopup<T> {
    ...
    public View onCreateView() {
        View inflate = View.inflate(mContext, R.layout.flyco_dialog_popup_bubble, null);
